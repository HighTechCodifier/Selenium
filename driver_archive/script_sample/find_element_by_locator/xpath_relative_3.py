# -*- coding: utf-8 -*-
"""
Finding element by relational_XPATH using astric
    Description:
        ...
        relative-XPath expression using asterisk:
"""
...
# Find element by relational_XPATH using astrix:
expression = "//*[text()='Italiano']"
